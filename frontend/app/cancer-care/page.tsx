      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="max-w-6xl mx-auto px-4 py-10">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Speciality / <span className="text-gray-700">Cancer Care</span>
          </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div>
                ...
                <p className="font-semibold text-gray-700 mb-3">
                  Compassion that travels with you
                </p>

                <p className="text-gray-600 text-sm leading-relaxed">
                  Multidisciplinary oncology nurses, dieticians,
                  psycho-oncologists, and pain specialists coordinate each chemo
                  cycle and recovery day.
                </p>

                <p className="text-gray-600 text-sm mt-3">
                  From PICC line maintenance to neutropenia precautions, every
                  detail is documented and shared with your oncologist.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
              <StatCard title="CHEMO SIDE-EFFECT RELIEF" value="87%" />
              <StatCard title="NUTRITION ADHERENCE" value="91%" />
              <StatCard title="COUNSELLING SESSIONS" value="1200+/yr" />
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FeatureCard
                  ...
                  desc="24×7 hotline to assess fever, mucositis, or breakthrough pain early."
                />
                <FeatureCard
                  number="2"
                  title="Caregiver coaching"
                  desc="Training families on PPE handling, cytotoxic waste, and burnout."
                />
                <FeatureCard
                  number="3"
                  title="Integrative wellness"
                  desc="Mindfulness, art therapy, and lymphatic massages for holistic relief."
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
              <div className="border rounded-xl p-6">
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex gap-2">
                    ...
                    Personalized chemo calendar & hydration plan
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Lab value tracking with alerts to oncologist
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle className="w-4 h-4 text-blue-600 mt-0.5" />
                    Transportation + infusion lounge partners
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  We connect you to NGO grants and insurer fast-tracks.
                </p>
            ...
            <div className="mt-14">
              ...
              <h2 className="text-xl font-bold mb-4">
                Frequently asked about cancer care programs
              </h2>
